...
_liboqs_lib: Optional[ctypes.CDLL] = None
...
def get_liboqs() -> Optional[ctypes.CDLL]:
...
def get_kem_details(alg_name: str) -> Optional[dict]:
...
def get_sig_details(alg_name: str) -> Optional[dict]:
