...
def main(verbose: bool, config_path: Optional[str]) -> None:
...
def bench(algorithm: str, count: int, output: Optional[str], output_format: str) -> None:
...
def keygen(algorithm: str, public_key: Optional[str], private_key: Optional[str], output_dir: str) -> None:
